    ...
    <div className="min-h-[100dvh] flex flex-col font-sans bg-background text-foreground">
      <header className="sticky top-0 z-50 w-full border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60 shadow-sm">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <Link to="/commission-calculator" className={`hover:text-primary transition-colors ${location.pathname === '/commission-calculator' ? 'text-primary' : 'text-muted-foreground'}`}>Commission</Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-16 z-40 bg-background border-b shadow-md flex flex-col p-4 gap-4">
          ...
          <Link to="/1099-vs-w2" className="flex items-center gap-3 p-3 rounded-md hover:bg-muted font-medium" onClick={closeMenu}>
            <Scale size={20} className="text-violet-500" /> 1099 vs W-2 Compare
          </Link>
          ...
          <Link to="/commission-calculator" className="flex items-center gap-3 p-3 rounded-md hover:bg-muted font-medium" onClick={closeMenu}>
            <TrendingUp size={20} className="text-orange-500" /> Commission Calculator
          </Link>
